...
long                libusb_ReadTimeout  = 0;
long                libusb_WriteTimeout = 0;
...
int _get_libusb_device_offset_from_arcos_offset(libusb_device **list, ssize_t list_count, 
	 struct libusb_device_descriptor *descriptor, long dwNumDevice) {
int i;
...
int _send_urb_control(libusb_device_handle* device_handle, int id) {
...
bool fnPerformaxComOpen(long dwDeviceNum, libusb_device_handle** device_handle) {
    ssize_t device_count, i;
    libusb_device **list;
    struct libusb_device_descriptor descriptor;
    bool result;
...
bool fnPerformaxComClose(libusb_device_handle* device_handle) {
    bool result;
...
bool fnPerformaxComSendRecv(libusb_device_handle* device_handle, void *wBuffer, long dwNumBytesToWrite, long dwNumBytesToRead, void *rBuffer) {
    if (!InitializePerformaxLibrary()) {
        return AR_FALSE;
    }
...
bool fnPerformaxComFlush(libusb_device_handle* device_handle) {
    if (!InitializePerformaxLibrary()) {
        return AR_FALSE;
    }
